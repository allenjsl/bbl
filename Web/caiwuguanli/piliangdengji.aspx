<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="piliangdengji.aspx.cs"
    Inherits="Web.caiwuguanli.piliangdengji" %>
...
<body>
    ...
    <table width="900" cellspacing="1" cellpadding="0" border="0" align="center" style="margin: 10px;">
        <tbody>
            ...
            <tr class="even">
                ...
                <td align="center">
                    <asp:TextBox ID="txtBillno" runat="server" Width="80%" errmsg="发票/收据号不能为空！"></asp:TextBox>
                </td>
                <td align="center">
    ...
    <script type="text/javascript">
        function CheckingSave() {
            var msg = TestNoNULL("id", "txtPayDate,txtStaffName,txtBillno");
            if (msg.length > 0) {
                alert(msg);
                return false;
            }
