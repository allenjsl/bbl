<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tuikuan.aspx.cs" Inherits="Web.caiwuguanli.tuikuan" %>
...
<table width="800" cellspacing="1" cellpadding="0" border="0" align="center" style="margin: 0px;">
  <tbody><tr class="odd">
    <th width="86" height="30" bgcolor="#bddcf4" align="center">退款日期</th>
    <th width="86" bgcolor="#bddcf4" align="center">退款人</th>
    <th width="86" bgcolor="#bddcf4" align="center">退款金额</th>
    <th width="94" bgcolor="#bddcf4" align="center">退款方式</th>
  ...
  <tr class="even">
    ...
    <td align="center"><input type="checkbox" id="checkbox" value="<%=k %>" name="checkbox">
...
<table width="320" cellspacing="0" cellpadding="0" border="0" align="center">
  <tbody><tr>
    ...
    <td align="center" class="tjbtn02"><a onclick="parent.Boxy.getIframeDialog('<%=Request.QueryString["iframeId"] %>').hide();return false;" id="linkCancel" href="javascript:void(0);">
        关闭
  </tr>
</tbody></table>
</form>
