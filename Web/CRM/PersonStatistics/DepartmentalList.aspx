<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentalList.aspx.cs"
    Inherits="Web.CRM.PersonStatistics.DepartmentalList" MasterPageFile="~/masterpage/Back.Master" %>
...
<asp:Content ContentPlaceHolderID="c1" runat="server" ID="Content1">
                        ...
                        <asp:Repeater runat="server" ID="rptList">
                            <ItemTemplate>
                                <tr bgcolor="<%# Container.ItemIndex%2==0?"#e3f1fc":"#BDDCF4" %>">
                                    ...
                                    <td align="center">
                                        <%#GetAccouter(((EyouSoft.Model.StatisticStructure.InayaDepartStatistic)GetDataItem()).SalesClerk)%>
                                    </td>
                                    <td align="center">
                                        <%#Eval("PeopleCount")%>
                                    </td>
    ...
    $(function(){
        ...
        $("#searchbtn").bind("click",function(){
            ...
            //参数
            var para = {type:type,operid:operid,opername:opername,roadid:roadid, stime: stime, etime: etime};
            window.location.href = "/CRM/PersonStatistics/DepartmentalList.aspx?" + $.param(para);
            return false;
        });
