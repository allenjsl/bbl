<%@ Page Title="客户关怀_客户关系管理" Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true" CodeBehind="CustomerCare.aspx.cs" Inherits="Web.CRM.customerservice.CustomerCare" %>
<%@ Register Src="~/UserControl/ucCRM/CustomerServiceHeader.ascx" TagName="headerMenu" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="c1" runat="server">
<div class="mainbody">
   <uc1:headerMenu id="cu_HeaderMenu" runat="server" TabIndex="2"   UseMap="客户关怀"/>
 <div class="hr_10"></div>
...
<fieldset style="border:2px #A3D3F8 solid;">
        <legend>设置</legend>
       	<fieldset style="border:1px #A3D3F8 solid; width:50%; float:left; text-align:left; margin-right:10px;">
            <legend>发送范围</legend>
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr class="odd" style="line-height:22px;">
                <td width="18%" height="22px;" align="center">匹配号码：</td>
                <td width="82%"  >
              ...
              <tr class="even">
                <td height="90" align="center">输入号码：</td>
                <td>&nbsp;<textarea  id="txtMobile"  runat="server"  style="width:270px; height:70px;" ></textarea></td>
              </tr>
              <tr class="odd">
                <td height="30" colspan="2" align="left">&nbsp;&nbsp;<a href="javascript:;" onclick="return Care.putInFile();">导入号码</a> （<font class="fred">导入Excel和txt，选择发送范围后将不再允许导入</font>）</td>
              </tr>
            </table>
        </fieldset> 
        <fieldset style="border:1px #A3D3F8 solid; width:43%; text-align:right; float:left;">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr class="odd">
                ...
                <input type="checkbox"  id="chkName"  runat="server" onclick="Care.changeName(this);"/> 匹配姓名</td>
              </tr>
              <tr class="even">
                <td width="20%" height="90" align="center">输入内容：</td>
                <td width="80%" align="left">&nbsp;
                <textarea  id="txtSmsContent" style="width:250px; height:70px;" runat="server"></textarea></td>
              </tr>
              <tr class="odd">
                <td height="30" align="center">发送通道：</td>
                <td align="left">&nbsp;&nbsp;
        ...
        <table width="600" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="363" height="40" align="left">发送设置：<input type="radio" id="rdiFixTime" runat="server"  Checked="True"/>固定时间发送发送设置 <input  type="text"  class="searchinput" style="width:100px;" id="txtSendTime" runat="server" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/></td>
            <td width="237" align="left"><input type="radio"  id="rdiCondit" runat="server" /> 满足条件发送 
          ...
          <tr><td colspan="2" align="right"><table width="420" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td height="40" align="center"></td>
              <td align="center" class="tjbtn02"><a href="javascript:;" onclick="return Care.save();">保存</a></td>
              <td height="40" align="center" class="tjbtn02"><a href="javascript:;" onclick="return Care.reset();">重置</a></td>
            </tr>
          </table></td>
          </tr>
        </table>
        ...
        <script type="text/javascript">
            var Care =
           {
               ...
               openDialog: function(p_url, p_title, p_width, p_height) {
                   Boxy.iframeDialog({ title: p_title, iframeUrl: p_url, width: p_width, height: p_height, data: "<%=txtMobile.ClientID %>" });
               },
               //从文件导入号码
               putInFile: function() {
                   if (!$("#<%=txtMobile.ClientID %>").attr("disabled")) {
                       Care.openDialog("/SMS/ImportTelFromFile.aspx", "从文件导入号码", "800px", "500px");
                   }
                   return false;
               },
               //验证手机号码
