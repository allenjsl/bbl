<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeList.aspx.cs" Inherits="Web.CRM.ProfitStatistical.TimeList"
...
<asp:Content ContentPlaceHolderID="c1" runat="server" ID="Content1">
    ...
    <div class="mainbody">
        <div class="mainbody">
            ...
            <ul class="fbTab">
                ...
                <li><a href="/CRM/ProfitStatistical/TimeList.aspx" class="tabtwo-on">按时间统计</a></li>
                <div class="clearboth">
                </div>
            </ul>
            <div class="hr_10">
                ...
                <div class="tablelist">
                    <table width="100%" border="0" id="printtable" cellpadding="0" cellspacing="1">
                        ...
                        <asp:Repeater runat="server" ID="rptList">
                            <ItemTemplate>
                                <tr bgcolor="#e3f1fc" year="<%#Eval("CurrYear")%>" month="<%#Eval("CurrMonth") %>">
                                    <td align="center">
    ...
    $(function(){
        ...
        function getpara(){
            ...
            var areaid = <%=RouteAreaList1.ClientID %>.GetAreaId();
            var teamtype = <%=TourTypeList1.ClientID %>.GetTourTypeId();
            var para = { type: teamtype, lstime: lstime, letime: letime,cstime:cstime,cetime:cetime,saleman:saleman,salemanname:salemanname,depname:depname,depid:depid,areaid:areaid};
            return para;
        }
        $("#searchbtn").bind("click",function(){
            window.location.href = "/CRM/ProfitStatistical/TimeList.aspx?" + $.param(getpara());
            return false;
        });
        ...
        $("a.table").bind("click",function(){
         ...
         $("a.showteam").bind("click",function(){
	        ...
	        Boxy.iframeDialog({
		        iframeUrl:url + "?year=" + year + "&month=" + month,
		        title:"团队数",
		        modal:true,
		        width:"720",
		        height:"340px",
