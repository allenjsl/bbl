<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaList.aspx.cs" Inherits="Web.CRM.ProfitStatistical.AreaList"
    MasterPageFile="~/masterpage/Back.Master" Title="利润统计_销售分析_客户关系管理" %>
...
<asp:Content ContentPlaceHolderID="c1" runat="server" ID="Content1">
    ...
    <div class="mainbody">
        <div class="mainbody">
            ...
            <ul class="fbTab">
                <li><a href="/CRM/ProfitStatistical/AreaList.aspx" class="tabtwo-on">按区域统计</a></li>
                <li><a href="/CRM/ProfitStatistical/DepartmentalList.aspx">按部门统计</a></li>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="searchbox">
                                ...
                                至
                                <input type="text" class="searchinput time" readonly="readonly" id="cetime" value="<%=qesModel.CheckDateEnd==null?"":Convert.ToDateTime(qesModel.CheckDateEnd).ToString("yyyy-MM-dd") %>" /><br />
                                <label>
                                    操作人部门：
                                </label>
                ...
                <div class="tablelist">
                    <table width="100%" border="0" id="printtable" cellpadding="0" cellspacing="1">
                        <tr bgcolor="#BDDCF4">
                            ...
                            <%--<th width="8%" align="center">计调员</th>--%>
                        ...
                        <asp:Repeater runat="server" ID="rptList">
                            <ItemTemplate>
                                <tr bgcolor="#e3f1fc" tid="<%# Eval("AreaId") %>">
                                    <td align="center">
                                        <%#Eval("AreaName")%>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <a href="javascript:;" class="showteam">
                                            <%#Eval("TourPeopleNum")%></a>
                                    </td>
                                    <%--<td align="center" ><%#GetAccounter(((EyouSoft.Model.StatisticStructure.EarningsAreaStatistic)GetDataItem()).Logistics)%></td>--%>
                                    <td align="center">
    ...
    $(function(){
        ...
        $("#searchbtn").bind("click",function(){
            window.location.href = "/CRM/ProfitStatistical/AreaList.aspx?" + $.param(getpara());
            return false;
        });
        ...
        $("a.showteam").bind("click",function(){
	        ...
	        var atype = parseInt(tid)==0?2:-1;
	        Boxy.iframeDialog({
		        iframeUrl:url + "?areaid=" + tid + "&atype=" + atype,
		        title:"团队数",
		        modal:true,
		        width:"720",
		        height:"340px",
