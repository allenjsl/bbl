<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeList.aspx.cs" Inherits="Web.CRM.ProfitStatistical.TypeList"
...
<asp:Content ContentPlaceHolderID="c1" runat="server" ID="Content1">
    ...
    <div class="mainbody">
        <div class="mainbody">
            ...
            <ul class="fbTab">
                ...
                <li><a href="/CRM/ProfitStatistical/TypeList.aspx" class="tabtwo-on">按类型统计</a></li>
                ...
                <div class="tablelist">
                    <table width="100%" border="0" id="printtable" cellpadding="0" cellspacing="1">
                        ...
                        <asp:Repeater runat="server" ID="rptList">
                            <ItemTemplate>
                                <tr bgcolor="#e3f1fc" tid="<%# (int)((EyouSoft.Model.EnumType.TourStructure.TourType)Eval("TourType")) %>">
                                    <td align="center">
                                        <%# Eval("TourType") %>
                                    </td>
                                    <td align="center">
                                    ...
                                    <%--<td align="center" ><%# GetSalers(((EyouSoft.Model.StatisticStructure.EarningsTypeStatistic)Container.DataItem).SalesClerk)%></td>--%>
                                    <td align="center">
    ...
    $(function(){
        ...
        function getpara(){
            ...
            var para = {depname:depname,depid:depid,saleman:saleman,salemanname:salemanname,lstime:lstime,letime:letime,cstime:cstime,cetime:cetime };
            return para;
        }
        
        $("#searchbtn").bind("click",function(){
            window.location.href = "/CRM/ProfitStatistical/TypeList.aspx?" + $.param(getpara());
            return false;
        });
