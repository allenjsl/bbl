<%@ Page Title="购物-供应商管理" Language="C#" MasterPageFile="~/masterpage/Back.Master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Web.SupplierControl.Shopping.Default" %>
    ...
    <script type="text/javascript">
        var Shopping = {
            select: function() {
                ...
                //参数
                var para = { unionName: "", province: "", city: "" };
                para.unionName = unionName;
                para.city = city;
                para.province = province;
                window.location.href = "/SupplierControl/Shopping/Default.aspx?" + $.param(para);

                return false;
            },
            loadxls: function() {
                var url = "/SupplierControl/Shopping/ShoppingLoadExcel.aspx";
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "其他EXCEL",
                    modal: true,
            ...
            add: function() {
                var url = "/SupplierControl/Shopping/ShoppingAdd.aspx";
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "新增",
                    modal: true,
            ...
            show: function(that) {
                var url = "/SupplierControl/Shopping/ShoppingAdd.aspx?type=show&";
            ...
            modify: function(that) {
                var url = "/SupplierControl/Shopping/ShoppingAdd.aspx?type=modify&";
                var tid = that.parent().parent().attr("tid");
                Boxy.iframeDialog({
                    iframeUrl: url + "tid=" + tid,
                    title: "修改",
            ...
            del: function(that) {
                if (confirm("确认删除所选项?")) {
                    ...
                    $.newAjax({
                        type: "POST",
                        data: { "tid": tid },
                        url: "/SupplierControl/Shopping/Default.aspx?act=areadel",
                        dataType: 'json',
        ...
        $(function() {
            ...
            $("a.show").click(function() {
                Shopping.show($(this)); //查看
                return false;
            });
            $("a.trade").click(function() {
                Shopping.trade($(this)); //查看交易详情
                return false;
            });
            $("a.modify").click(function() {
                Shopping.modify($(this)); //修改
                return false;
            });
            $("a.del").click(function() {
                Shopping.del($(this)); //删除
                return false;
            });
            $("a.delall").click(function() {
                Shopping.delall(RowList); //批量删除
                return false;
            });
