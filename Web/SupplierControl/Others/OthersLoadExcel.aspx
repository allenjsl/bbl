<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OthersLoadExcel.aspx.cs"
    Inherits="Web.SupplierControl.Others.OthersLoadExcel" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function loadexcel(array) {
            ...
            loadXls.init(array, "#tablelist", ".s1"); //初始化arrer二维数组，table容器，calss=sl的
            ...
            $("#ok").bind("click", function() {
                ...
                if (datas.length > 0) {
                    ...
                    $.newAjax({
                        type: "post",
                        dataType: "json",
                        url: "OthersLoadExcel.aspx?act=load",
...
<body>
    ...
    <uc1:upload UploadSuccessJavaScriptFunCallBack="loadexcel" runat="server"  UploadFrom="其它"/>
