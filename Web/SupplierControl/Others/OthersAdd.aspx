<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OthersAdd.aspx.cs" Inherits="Web.SupplierControl.Others.OthersAdd" %>
            ...
            <tr class="even">
                ...
                <td colspan="3" align="left">
                    <input type="text" id="unionname" name="unionname" value="<%=csModel.UnitName %>"
                        class="searchinput02" valid="requred" errmsg="单位不能为空" />
                </td>
            </tr>
            <tr class="odd">
                <th height="30" align="center">
        ...
        <table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td height="40" align="center" class="tjbtn02">
                    <%if (!show)
                      { %><a href="javascript:;" class="save" id="a_save">保存</a><%} %>
                </td>
                <td height="40" align="center" class="tjbtn02">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("a.save").click(function() {
                ...
                var unionname = $("#unionname").attr("value"); //获取单位名称
