<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TradeSituation.aspx.cs"
    Inherits="Web.SupplierControl.TicketService.TradeSituation" %>
...
<body>
    ...
    <table width="99%" cellspacing="0" cellpadding="0" border="0" align="center" style="text-align: center">
        ...
        <table id="print" width="800" border="0" align="center" cellpadding="0" cellspacing="1"
            style="margin: 10px;">
            <tr class="odd">
            ...
            <asp:Repeater ID="repList" runat="server">
                <ItemTemplate>
                    <tr class="even">
                        ...
                        <td align="center">
                            <%# EyouSoft.Common.Utils.FilterEndOfTheZeroString(Convert.ToDecimal( Eval("AgencyPrice")).ToString("0.00"))%>
                        </td>
                        <td align="center">
                        ...
                        <td align="center">
                            <font class="fbred">
                                <%# EyouSoft.Common.Utils.FilterEndOfTheZeroString(Convert.ToDecimal(Eval("TotalAmount")).ToString("0.00"))%></font>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
            <tr class="odd">
                ...
                <td width="70" align="center">
                    <b>
                        <asp:Label ID="lblTicketPrice" runat="server" Text=""></asp:Label></b>
                </td>
                <td width="70" align="center">
                </td>
                <td width="70" align="center">
                    <b>
                        <asp:Label ID="lblAgencyPrice" runat="server" Text=""></asp:Label></b>
                </td>
                <td width="70" align="center">
                    <b>
                ...
                <td width="70" align="center">
                    <b>
                        <asp:Label ID="lblTotalAmount" runat="server" Text=""></asp:Label></b>
                </td>
            </tr>
            <%if (len == 0)
              { %>
    ...
    <script type="text/javascript">
        $(function() {
            $("#a_search").click(function() {
                ...
                window.location.href = '/SupplierControl/TicketService/TradeSituation.aspx?tid=<%=Request.QueryString["tid"]%>&' + $.param(para);
                return false;
            })
