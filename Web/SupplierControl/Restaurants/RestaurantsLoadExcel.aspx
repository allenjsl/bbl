<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RestaurantsLoadExcel.aspx.cs"
    Inherits="Web.SupplierControl.Restaurants.RestaurantsLoadExcel" %>
    ...
    <script type="text/javascript">
        function loadexcel(array) {
            ...
            $("#ok").bind("click", function() {
                ...
                $("#Cuisine").val(), $("#saddress").val(), $("#Profile").val(),
                $("#TourGuide").val(), $("#ContectName").val(), $("#ContectJob").val(),
                $("#ContectTel").val(), $("#ContectPhone").val(), $("#ContectQQ").val(),
                                     $("#ContectE-Mail").val(), $("#sremark").val()]);
                ...
                if (datas.length > 0) {
                    ...
                    $.newAjax({
                        type: "post",
                        dataType: "json",
                        url: "RestaurantsLoadExcel.aspx?action=load",
...
<body>
    <uc1:upload ID="Upload1" UploadSuccessJavaScriptFunCallBack="loadexcel" runat="server" UploadFrom="餐馆"/>
                        ...
                        <table cellspacing="0" id="tbl_Cell" cellpadding="5" width="98%" align="center" border="0">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <label>导游词：</label>
                                        <select id="TourGuide" class="s1">
                                        </select>
                                    </td>
                                    <td>
                                        <label>联系人姓名：</label>
                                        <select id="ContectName" class="s1">
                                        </select>
                                    </td>
                                    <td>
                                        <label>联系人职务：</label>
                                        <select id="ContectJob" class="s1">
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>联系人电话：</label>
                                        <select id="ContectTel" class="s1">
                                        </select>
                                    </td>
                                    <td>
                                        <label>联系人手机：</label>
                                        <select id="ContectPhone" class="s1">
                                        </select>
                                    </td>
                                    <td>
                                        <label>联系人QQ：</label>
                                        <select id="ContectQQ" class="s1">
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <select id="ContectE-Mail" class="s1">
                                        </select>
                                    </td>
                                    <td>
                                        <label>备注：</label>
