<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RestaurantsAdd.aspx.cs"
    Inherits="Web.SupplierControl.Restaurants.RestaurantsAdd" %>
    ...
    <div>
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="1" style="margin-top: 10px;">
            ...
            <tr class="even">
                ...
                <td align="left">
                    <input type="text" id="Txtunitsnname" name="Txtunitsnname" value="<% =Restaurantinfo.UnitName %>"
                        class="searchinput searchinput02" />
                </td>
                <th align="center">菜系:</th>
                <td align="left">
                   <input  type="text" id="TxtCuisine" name="TxtCuisine" class="searchinput searchinput02" value="<%=Restaurantinfo.Cuisine %>"/>
                </td>
            </tr>
            <tr class="odd">
                ...
                <td colspan="3" align="left">
                    <input type="text" id="TxtAddress" name="TxtAddress" value="<% =Restaurantinfo.UnitAddress %>"
                        class="searchinput searchinput02" />
                </td>
            </tr>
            <tr class="even">
                ...
                <td colspan="3" align="left">
                    <textarea name="ResProfile" id="ResProfile" cols="45" rows="5" class="textareastyle"><% =Restaurantinfo.Introduce%></textarea>
                </td>
            </tr>
            <tr class="odd">
                <th height="30" align="center">
                ...
                <td colspan="3" align="left">
                    <textarea name="TourGuids" id="TourGuids" cols="45" rows="5" class="textareastyle"><% =Restaurantinfo.TourGuide%></textarea>
                </td>
            </tr>
            <tr class="even">
                <th align="center">
                 ...
                 <td colspan="3" align="left">
                   <table id="userlist" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                          ...
                          <%if (Restaurantinfo.SupplierContact != null && Restaurantinfo.SupplierContact.Count > 0)
                            {
                                int temp = 0;
                                foreach (EyouSoft.Model.CompanyStructure.SupplierContact sc in Restaurantinfo.SupplierContact)
                                {
                                     %>
                          <tr class="<% =temp%2==0?"even":"odd" %>">
                            ...
                            <th align="center"><input  type="text" name="inefax" class="searchinput inefax" value="<%=sc.ContactFax %>" /></th>
            ...
            <tr class="odd">
                ...
                <td colspan="3">
                    <textarea name="TxtRemarks" id="TxtRemarks" cols="45" rows="5" class="textareastyle"><% =Restaurantinfo.Remark%></textarea>
                </td>
            </tr>
        </table>
        <table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td height="40" align="center" class="tjbtn02"><%if (!show)
                                                                 { %>
                   <asp:LinkButton ID="LinkButton" runat="server"  OnClientClick="return checkForm();"
                        onclick="LinkButton_Click">保存</asp:LinkButton><%} %>
                </td>
                <td height="40" align="center" class="tjbtn02">
                    <a href="javascript:;" onclick="parent.Boxy.getIframeDialog('<%=Request.QueryString["iframeId"] %>').hide()";>关闭</a>
                </td>
            </tr>
        </table>
