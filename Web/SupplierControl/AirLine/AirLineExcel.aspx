<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AirLineExcel.aspx.cs" Inherits="Web.SupplierControl.AirLine.AirLineExcel" %>
            ...
            $("#ok").bind("click", function() {
                ...
                if (datas.length > 0) {
                    ...
                    $.newAjax({
                        type: "post",
                        dataType: "json",
                        url: "AirLineExcel.aspx?type=load",
...
<body>
    ...
    <uc1:upload UploadSuccessJavaScriptFunCallBack="loadexcel" runat="server" UploadFrom="航空" />
