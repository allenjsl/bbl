<%@ Page Title="航空公司_供应商管理" Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true" CodeBehind="AirLineList.aspx.cs" Inherits="Web.SupplierControl.AirLine.AirLineList" %>
            ...
            <div class="btnbox">
                <table width="45%" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <%if (grantdel)
                          { %><td width="90" align="center">
                              <a href="javascript:;" id="delall">批量删除</a>
                          </td>
                        <%} %>
                        <%if (grantload)
                          { %><td width="90" align="center">
                              <a href="javascript:;" id="loadxls">
    ...
    <script type="text/javascript">
        var Others = {
            select: function() {
                ...
                window.location.href = "/SupplierControl/AirLine/AirLineList.aspx?" + $.param(para);
                return false;
            },
            loadxls: function() {
            var url = "/SupplierControl/AirLine/AirLineExcel.aspx";
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "其他EXCEL",
                    modal: true,
            ...
            trade: function(that) {
            var url = "/SupplierControl/AirLine/AirLineAdd.aspx?";
            ...
            show: function(that) {
            var url = "/SupplierControl/AirLine/AirLineAdd.aspx?type=show&";
                var tid = that.parent().parent().attr("tid");
                Boxy.iframeDialog({
                    iframeUrl: url + "tid=" + tid,
                    title: "查看",
            ...
            var url = "/SupplierControl/AirLine/AirLineAdd.aspx?type=modify&";
                var tid = that.parent().parent().attr("tid");
                Boxy.iframeDialog({
                    iframeUrl: url + "tid=" + tid,
                    title: "修改",
            ...
            del: function(that) {
                if (confirm("确认删除所选项?")) {
                    ...
                    $.newAjax({
                        type: "POST",
                        data: { "tid": tid },
                        url: "/SupplierControl/AirLine/AirLineList.aspx?type=del",
                        dataType: 'json',
            ...
            toxls: function() {
                ...
                if (url.indexOf("?") >= 0) { url += "&type=toexcel"; } else { url += "?type=toexcel"; }
