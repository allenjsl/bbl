...
namespace Web.sales
{
    ...
    /// 1、2011-01-12 曹胡生 创建
    /// </summary>
    public partial class Order_tuipiao : BackPage
    {
        ...
        {
            //订单ID
            string orderID = EyouSoft.Common.Utils.GetQueryStringValue("id").Trim();
            System.Text.StringBuilder stringBuilder = new System.Text.StringBuilder();
            EyouSoft.BLL.TourStructure.TourOrder TourOrderBll = new EyouSoft.BLL.TourStructure.TourOrder();
            System.Collections.Generic.IList<EyouSoft.Model.TourStructure.TourOrderCustomer> cusList = TourOrderBll.GetCanRefundTicketTravellers(orderID.ToString());
            ...
            if (cusList != null && cusList.Count > 0)
            {
                ...
                foreach (EyouSoft.Model.TourStructure.TourOrderCustomer cusModel in cusList)
                {
                    ...
                    if (cusModel != null)
                    {
                        ...
                        stringBuilder.Append("</td>");
                        stringBuilder.Append("<td bgcolor=\"#e3f1fc\" align=\"center\">");
                        stringBuilder.AppendFormat("<a sign=\"tuipiao\" href=\"Tuipiao.aspx?cusID={0}\">退票</a>", cusModel.ID);
