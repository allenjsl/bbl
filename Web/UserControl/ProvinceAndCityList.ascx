<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProvinceAndCityList.ascx.cs" Inherits="Web.UserControl.ProvinceAndCityList" %>
 <span class="unnamed1" id="ProvinceRequired" style="display:none" >*</span>省份：<asp:DropDownList ID="ddl_ProvinceList" runat="server" >
</asp:DropDownList><span class="unnamed1"  id="CityRequired" style="display:none">*</span>城市：<asp:DropDownList ID="ddl_CityList" runat="server" >
</asp:DropDownList>
