<%@ Page Title="账户信息_短信中心" Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true" CodeBehind="AccountInfo.aspx.cs" Inherits="Web.SMS.AccountInfo" %>
...
<form runat="server" id="accountForm">
 <uc1:headerMenu id="cu_HeaderMenu" runat="server" TabIndex="5" />
            	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" class="yue">当前您的余额为：
                      <span><asp:Literal ID="litRemainMoney" runat="server"></asp:Literal></span>元 <span class="pandl10">
                      
                      <a href="javascript:;" onclick="return AccountInfo.recharge();" ><img src="/images/dx-chongzhi.gif" alt="" width="151" height="44" /></a></span></td>
                    </tr>
              </table>
