<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxReChargeAndConsume.aspx.cs" Inherits="Web.SMS.AjaxReChargeAndConsume" %>
...
<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="asp" %>
  <% if (recharge)
     { %>
  <tr id="tr_recharge" >
                      <td width="15%" align="right" valign="middle" bgcolor="#bddcf4" class="yue"><strong>充值明细：</strong></td>
                      <td width="85%">
                      <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                          <th width="25%" height="26" align="center" bgcolor="#bddcf4">充值时间</th>
                          <th width="25%" height="26" align="center" bgcolor="#bddcf4"><strong>充值金额</strong></th>
                          <th width="25%" height="26" align="center" bgcolor="#bddcf4">充值状态</th>
                          <th width="25%" height="26" align="center" bgcolor="#bddcf4"><strong>充值人</strong></th>
                        </tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="right">
                             <uc2:ExporPageInfoSelect ID="ExporPageInfoSelect1" runat="server" PageStyleType="NewButton"  LinkType="2"  HrefType="JsHref" ></uc2:ExporPageInfoSelect>
                          </td>
                        </tr>
                      </table>
                      </td>
   ...
   <%if (consume)
     { %>             
  <tr  id="tr_consume"  >
                      <td align="right" valign="middle" bgcolor="#bddcf4" class="yue"><strong>消费明细：</strong></td>
                      <td>
                      <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                          <th width="20%" height="28" align="center" bgcolor="#BDDCF4">发送时间</th>
                          <th width="15%" height="28" align="center" bgcolor="#bddcf4"><strong>号码</strong></th>
                          <th width="31%" height="28" align="center" bgcolor="#bddcf4">发送内容</th>
                          <th width="10%" height="28" align="center" bgcolor="#bddcf4"><strong>价格</strong></th>
                          <th width="14%" height="28" align="center" bgcolor="#bddcf4">发送通道</th>
                        </tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="right">
                             <uc2:ExporPageInfoSelect ID="ExporPageInfoSelect2" runat="server" PageStyleType="NewButton"  LinkType="2"  HrefType="JsHref" ></uc2:ExporPageInfoSelect>
                          </td>
                        </tr>
                      </table>
                      </td>
