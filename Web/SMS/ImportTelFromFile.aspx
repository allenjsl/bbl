<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportTelFromFile.aspx.cs" Inherits="Web.SMS.ImportTelFromFile" %>
...
<head id="Head1" runat="server">
    ...
    function loadexcel(array){
        ...
        $("#ok").bind("click", function() {
            ...
            var txtMobile = window.parent.document.getElementById(nowBoxy.options.data);
            if (mobileMess != "") {
...
<body>
    ...
    <uc1:upload ID="Upload1" UploadSuccessJavaScriptFunCallBack="loadexcel" runat="server" ContainsTxt="true" />
