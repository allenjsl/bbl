<%@ Page Title="客户列表_短信中心" Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true" CodeBehind="SmsCustomerList.aspx.cs" Inherits="Web.SMS.SmsCustomerList" %>
 ...
 <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td height="30" valign="top"><div class="searchbox" style="height:30px;">单位名称：
              ...
              客户分类：
              <select name="select" runat="server" id="selCustType">
            ...
            <tr>
              ...
              <td width="90" align="center"><a href="javascript:;"  onclick="return Sms.del('');">删除</a></td>
            	...
            	<table width="100%" border="0" cellpadding="0" cellspacing="1">
                  <tr>
                    <th width="8%" align="center" bgcolor="#BDDCF4">全选<input type="checkbox"  id="chkAll" onclick="Sms.selAll(this);" /></th>
                    ...
                    <th width="18%" align="center" bgcolor="#bddcf4">客户分类</th>
                    ...
                    <ItemTemplate>
                        <tr>
                        <td  align="center" bgcolor="#e3f1fc"><input type="checkbox" class="c1"  value="<%# Eval("Id") %>"/>
                        <%# itemIndex++%></td>
                        <td align="center" bgcolor="#e3f1fc"><%# Eval("MobileNumber")%></td>
                        <td align="center" bgcolor="#e3f1fc"><%# Eval("CustomerCompanyName")%></td>
                        <td align="center" bgcolor="#e3f1fc"><%# Eval("CustomerContactName")%></td>
                  ...
                  <tr>
                    <td  align="center" bgcolor="#BDDCF4"><input type="checkbox" class="c1"  value="<%# Eval("Id") %>"/>
                    <%# itemIndex++%></td>
                    <td align="center" bgcolor="#BDDCF4"><%# Eval("MobileNumber")%></td>
                    <td align="center" bgcolor="#BDDCF4"><%# Eval("CustomerCompanyName")%></td>
                    <td align="center" bgcolor="#BDDCF4"><%# Eval("CustomerContactName")%></td>
