...
<body>
    ...
    <table width="700" border="0" align="center" cellpadding="0" cellspacing="1" style="margin:20px auto;">
	  ...
	  <tr class="odd">
        <th width="6%" height="20" align="center"><span id="Span1">序号</span> </th>
        <th width="17%" height="20" align="center">类型 </th>
        <th width="77%" height="20" align="center">常用语 </th>
      </tr>
      <asp:CustomRepeater ID="rptSms" runat="server">
       <ItemTemplate>
	      <tr class="odd">
        <td width="6%" height="20" align="center" bgcolor="#E3F1FC"><input class="c1" name='r1' type="radio" value='<%# Eval("Id") %>'  />
          <span id="Recommounse_ctl00_lblContentID"><%#itemIndex++ %></span> </td>
        <td width="17%" height="20" align="center" bgcolor="#E3F1FC"><%# Eval("ClassName") %></td>
        <td height="20" align="left" bgcolor="#E3F1FC" class="pandl3" name="nameC"><%# Eval("WordContent") %> </td>
      </tr>
      </ItemTemplate>
      <AlternatingItemTemplate>
	     <tr class="odd">
        <td width="6%" height="20" align="center"><input  class="c1"  type="radio" name='r1' value='<%# Eval("Id") %> '/>
         <span id="Recommounse_ctl00_lblContentID"><%#itemIndex++ %></span> </td>
        <td width="17%" height="20" align="center"><%# Eval("ClassName") %></td>
        <td height="20" align="left" class="pandl3"  name="nameC"><%# Eval("WordContent") %> </td>
      </tr>
     </AlternatingItemTemplate>
	 </asp:CustomRepeater>
	  <tr class="odd">
      ...
      <tr class="odd">
        <td height="30" colspan="9" align="center">
         ...
         <tr>
            <td width="86" height="40" align="center" class="tjbtn02"><a href="javascript:;" onclick="return selSms();">确认</a></td>
            <td width="86" height="40" align="center" class="tjbtn02"><a href="javascript:;" onclick="return dClose();">取消</a></td>
          </tr>
        </table>        </td>
      </tr>
</table>
    ...
    <script type="text/javascript">
        ...
        function selSms() {
            ...
            $(".c1:checked").each(function() {
                smsArr.push($(this).parent().siblings("td[name='nameC']").html());
            });
