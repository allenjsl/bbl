<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCommonSms.aspx.cs" Inherits="Web.SMS.EditCommonSms" %>
...
<body>
    ...
    <table width="500" border="0" align="center" cellpadding="0" cellspacing="1" style="margin:20px auto;">
      <tr class="odd">
        <th width="18%" height="30" align="right">类型：</th>
        <td width="82%" bgcolor="#E3F1FC">
               <select id="selClass"  runat="server" valid="required"  errmsg="类型不为空">
			   
              </select>
              <img src="/images/add2.gif" /><a href="javascript:;" onclick="return SmsCommon.toggleClass();">新增</a>
              <span id="spanClass" style="display:none">
              <input type="text" id="txtSmsClass"  style="widows:80px" maxlength="15"/><input type="button" id="btnSave" onclick="SmsCommon.addClass();" value="增加" /></span>
              <a href="javascript:;" onclick="SmsCommon.delClass();">删除</a><span id="errMsg_<%=selClass.ClientID %>" class="errmsg" ></span>
         
         </td>
      </tr>
	  <tr class="odd">
        <th width="18%" height="30" align="right">短信内容：</th>
        <td width="82%" bgcolor="#E3F1FC">
        <textarea cols="45" rows="5" id="txtSmsContent"  runat="server" onkeyup="SmsCommon.fontNum(this);" style="vertical-align:top"  valid="required"  errmsg="内容不为空"></textarea>
        <span id="errMsg_<%=txtSmsContent.ClientID %>" class="errmsg" ></span>
        <div style="color:Red;">注：短信内容不能超过70个字，当前字数<font id="smsNum">0</font></div></td>
      </tr>
      ...
      <tr class="odd">
        <td height="30" colspan="8" align="left" bgcolor="#E3F1FC">
         ...
         <tr>
            ...
            <td width="76" height="40" align="center" class="tjbtn02"><a href="javascript:;" id="btn_save" onclick="return SmsCommon.save('');">保存</a></td>
