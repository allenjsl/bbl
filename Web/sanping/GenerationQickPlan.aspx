<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerationQickPlan.aspx.cs" Inherits="Web.sanping.GenerationQickPlan" %>
    ...
    <form runat="server" id="myform" enctype="multipart/form-data">
        <table width="880" border="0" align="center" cellpadding="0" cellspacing="1" style="margin:10px;">
            <tr class="even">
                ...
                <td><input type="hidden" id="hd_area" name="hd_area" runat="server" value=""/><select valid="required" errmsg="*请选择计调员" id="sel_oprator" name="sel_oprator"><option value="">请先选择线路区域</option></select></td>
            </tr>
            <tr class="odd">
                <th align="right">
                    去程航班/时间
            ...
            <tr class="even">
                ...
                <td align="left" colspan="3">
                    <input type="text" errmsg="*请输入预控人数!|*请正确输入预控人数!" valid="required|isNumber"  class="searchinput" id="txt_ykrs" name="txt_ykrs" runat="server"/>
					<input type="hidden" value="" id="hd_num" runat="server"/>
                </td></tr>
            <tr class="odd">
                <th align="right">
                    文件上传
...
<%
                                ...
                                <div>
                                    <div class="dlprice" style="width:750px;background:none;">
                                        ...
                                        <%foreach (var v in sinfo[i].CustomerLevels)
                                          { %>
                                        <div class="left" style="width:190px; background:none;">
                                            <div class="title" style="background:none;">
                                                <%=v.LevelName%>
                ...
                <tr class="odd">
                <td colspan="4" class="tjbtn02" align="center">
