<%@ Page Title="散客天天发_散拼计划" Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true" CodeBehind="DaydayAdd.aspx.cs" Inherits="Web.sanping.DaydayAdd" %>
    ...
    <div class="mainbody">
        ...
        <div class="mainbody">
            ...
            <%if (EyouSoft.Common.Utils.GetQueryStringValue("act") != "update")
              {
                 %>
                <li><a id="A1" href="DaydayQuickAdd.aspx">快速发布</a></li>
                <%} %>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="4">                                   
                                    <uc1:xianluWindow Id="selectXl" runat="server" callBack="bindxlInfo" publishType="2" />
                                </td>
                            </tr>
                            <tr>
                                <td width="10%" height="30" align="right">
                                    ...
                                    <div class="dlprice" style="width:470px">
                                       <div class="left">
                                        ...
                                        <%-- <div class="left">
                                            ...
                                            <div>
                                                成人
                                                <input class="jiesuantext" id="text1" name="txt_ms_cr_price" type="text">
                                                儿童
                                                <input class="jiesuantext" id="text2" name="txt_ms_rt_price" type="text">
                                            </div>
                                        </div>
                                        <div class="left">
                                            <div class="title">
                                            ...
                                            <div>
                                                成人
                                                <input class="jiesuantext" id="text3" name="txt_th_cr_price" type="text">
                                                儿童
                                                <input class="jiesuantext" id="text4" name="txt_th_rt_price" type="text">
                                            </div>
                                        </div>--%>
                                        ...
                                        <div class="left" style="width:155px;">
                                            <div class="title">
                                                <%#Eval("CustomStandName")%><input type="hidden" name="hd_cusStandType" value="<%#Eval("LevType") %>"><input type="hidden" name="hd_cusStandId" value="<%#Eval("Id") %>"/><input type="hidden" name="hd_cusStandName" value="<%#Eval("CustomStandName") %>"/></div>
                                            <div>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="4">
                                    <uc2:xingcheng ID="xingcheng1" runat="server" daysControlName="txt_Days" />
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table width="100%" cellspacing="1" cellpadding="0" border="0">
                                        <tbody>
                                            ...
                                            <tr bgcolor="#bddcf4">
                                                ...
                                                <td bgcolor="#e3f1fc" align="left" colspan="3"><textarea class="textareastyle" id="txt_nbinfo" runat="server" name="txt_nbinfo"></textarea></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
