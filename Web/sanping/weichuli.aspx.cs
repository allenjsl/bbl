...
namespace Web.sanping
{
    ...
    /// by 田想兵 3.24
    /// </summary>
    public partial class weichuli : Eyousoft.Common.Page.BackPage
    { 
        ...
        void BindList()
        {
            ...
            int count = 0;
            IList<EyouSoft.Model.TourStructure.LBTourEverydayHandleInfo> list = bll.GetTourEverydayUntreatedApplys(CurrentUserCompanyID, Utils.GetQueryStringValue("tourid"), 20, EyouSoft.Common.Utils.GetInt(Request.QueryString["page"], 1), ref  count);
