<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateQuote.aspx.cs" Inherits="Web.xianlu.UpdateQuote"
    MasterPageFile="~/masterpage/Back.Master" ValidateRequest="false" Title="快速发布_线路管理" %>
...
<asp:Content ContentPlaceHolderID="c1" ID="Content1" runat="server">
    ...
    <div class="mainbody">
        ...
        <ul class="fbTab">
            <li><a href="javascript:viod(0);" class="tabtwo-on">快速发布</a></li>
            <div class="clearboth">
            </div>
        </ul>
        <div class="addlinebox" id="AddLineboxList">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" id="con_two_1">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="searchinput searchinput02" id="txt_LineName" name="txt_LineName"
                            runat="server" valid="required" errmsg="请填写线路名称!">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="searchinput searchinput02" id="txt_Description" name="txt_Description"
                            runat="server">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="searchinput searchinput03" id="txt_Days" name="txt_Days"
                            runat="server" valid="required" errmsg="请填写旅游天数!">
                ...
                <tr>
                    ...
                    <td class="updom">
                        <%if (Attach != null && Attach.Count > 0)
                          {
                              int temp = 0;
                              foreach (EyouSoft.Model.TourStructure.TourAttachInfo attachinfo in Attach)
                              {
                                  if (attachinfo.Name != "" && attachinfo.FilePath != "")
                                  {
                              %>
                         <a href="<%=attachinfo.FilePath %>" target="_blank">查看附件</a><img src="/images/fujian_x.gif"
                        style="cursor: pointer" width="14" height="13" class="close" alt="" />
                        <%temp++;
                                  }
                                  else
                                  {%>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="searchinput searchinput02" id="txt_Travel" name="txt_Travel"
                            runat="server" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="txt_Remarks" id="txt_Remarks" class="txt_Remarks" runat="server"
     ...
     //初始化编辑器
        ...
        $(document).ready(function() {
            ...
            $("img.close").click(function() {
                var that = $(this);
                $("td.updom").html("<input type=\"hidden\" name=\"filehid\" id=\"filehid\" value=\"dele\"/> <input type=\"file\" name=\"fileUpLoad\" id=\"fileUpLoad\" />");
            });
