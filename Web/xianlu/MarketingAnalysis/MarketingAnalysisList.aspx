<%@ Page Language="C#" Title="按区域统计_营销分析_线路产品库" AutoEventWireup="true" CodeBehind="MarketingAnalysisList.aspx.cs" Inherits="Web.MarketingAnalysisList" MasterPageFile="~/masterpage/Back.Master" %>
...
<asp:Content ID="cphMarketing" runat="server" ContentPlaceHolderID="c1">
    ...
    <div class="mainbody">
        <div class="lineprotitlebox">
         ...
         <div class="hr_10"></div>
        <ul class="fbTab">
          <li><a href="#" id="two1" class="tabtwo-on">按区域统计</a></li>
...
&nbsp;<label>下单时间：</label>
            ...
            <div class="btnbox">
              <table width="40%" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="90" align="center"><a id="aPrint" href="javascript:void(0);" target="_blank" onclick="MarketAnalysitList.GetPrintInfo(aPrint);return false;">打 印</a></td>
                  <td width="90" align="center">
                      <a href="/xianlu/MarketingAnalysisList.aspx?IsExcel=1"><img src="/images/daoru.gif"/> 导 出</a></td>
          ...
          <table id="StatTable" width="100%" border="0" cellpadding="0" cellspacing="1">
            <tr>
                  <th width="13%" align="center" bgcolor="#BDDCF4">线路区域</th>
