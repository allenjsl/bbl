<%@ Page Language="C#" Title="散客确认单" MasterPageFile="~/masterpage/Print.Master" AutoEventWireup="true"
    CodeBehind="VisitorsConfirmPrint.aspx.cs" Inherits="Web.print.bbl.VisitorsConfirmPrint" %>
...
<asp:Content ID="c1" ContentPlaceHolderID="PrintC1" runat="server">
    ...
    <table width="760px" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <th height="35" colspan="2" align="left" valign="middle">
                账户名称：米珈颍 （请按以下银行账号为准，以前银行账号均作废）
            </th>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                1、交通银行（大连民兴支行） 622260 0410 0045 72276
            </td>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                2、农业银行（大连天津街支行）62284 8056 00317 48711
            </td>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                3、 建设银行（大连天津街支行）622700 078 118 0031021
            </td>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                4、 招商银行（大连分行营业部）62260 9411 0137633
            </td>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                5、 工商银行（大连天津街支行） 6222340025005546
            </td>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                6、 邮政储蓄 622188 2220 004835180
            </td>
        </tr>
        <tr>
            <td height="30" colspan="2" align="left" valign="middle">
                7、 对公账户<br />
                &nbsp;&nbsp;&nbsp; 用户名：大连巴比来旅行社有限公司<br />
                &nbsp;&nbsp;&nbsp; 开户行：光大银行大连分行 账号：3571 0188 000065496<br />
