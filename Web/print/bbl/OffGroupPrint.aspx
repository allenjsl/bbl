<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OffGroupPrint.aspx.cs"
    Title="送团单" Inherits="Web.print.bbl.OffGroupPrint" MasterPageFile="~/masterpage/Print.Master" %>
    ...
    <script type="text/javascript">
        $(function() {
            $("#btnSave").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/print/bbl/OffGroupPrint.aspx?type=save",
