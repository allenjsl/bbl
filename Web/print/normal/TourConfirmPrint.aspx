<%@ Page Title="团 队 报 价 单" Language="C#" MasterPageFile="~/masterpage/Print.Master" AutoEventWireup="true" CodeBehind="TourConfirmPrint.aspx.cs" Inherits="Web.print.normal.TourConfirmPrint" %>
        ...
        <tbody>
            <tr>
                <td height="30" align="center" class="normaltd">
                    <span style="font-size: 20px; font-weight: bold;">团 队 报 价 单</span>
                </td>
            </tr>
