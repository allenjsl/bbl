    ...
    public partial class StandardSanFightPrint : System.Web.UI.Page
    {
        ...
        protected void DataInit(string tourId)
        {
            ...
            if (model != null)
            {
                ...
                //不含项目
                this.lblNoProject.Text = model.TourNormalInfo.BuHanXiangMu;
                //购物安排
                this.lblBuy.Text = model.TourNormalInfo.GouWuAnPai;
                //儿童安排
                this.lblChildPlan.Text = model.TourNormalInfo.ErTongAnPai;
                //自费项目
                this.lblSelfProject.Text = model.TourNormalInfo.ZiFeiXIangMu;
                //注意事项
                this.lblNote.Text = model.TourNormalInfo.ZhuYiShiXiang;
                //温馨提示
                this.lblTips.Text = model.TourNormalInfo.WenXinTiXing;
                //行程安排
