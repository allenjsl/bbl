<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderVisitorsListPrint.aspx.cs" Inherits="Web.print.normal.groupend.OrderVisitorsListPrint" MasterPageFile="~/masterpage/Print.Master" Title="游客名单" %>
...
<asp:Content ID="c1" ContentPlaceHolderID="PrintC1" runat="server">
    ...
    <table width="759px" class="table_normal2" align="center" style="margin-top: 20px;">
        <tr height="30">
        ...
        <cc1:CustomRepeater ID="rptVisitorList" runat="server" EmptyText="<tr height='30'><td colspan='6' class='normaltd'>无游客名单</td></tr>">
            <ItemTemplate>
                <tr height="30">
                    <td align="center">
