<%@ Page Title="行程单" Language="C#" AutoEventWireup="true" CodeBehind="FastTourInfoPrint.aspx.cs" Inherits="Web.print.normal.FastTourInfoPrint" MasterPageFile="~/masterpage/Print.Master" %>

<asp:Content ID="Content2" ContentPlaceHolderID="PrintC1" runat="server">
    <table align="center" width="759px">
        <tbody>
            <tr>
                <td height="30">
                    <table class="table_normal2" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center" width="30%">
                                    人 数：
                                    <asp:Label ID="lblAdult" runat="server" Text=""></asp:Label><asp:Label ID="lblChild"
