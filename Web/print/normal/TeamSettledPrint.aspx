<%@ Page Title="团队结算单" Language="C#" AutoEventWireup="true" CodeBehind="TeamSettledPrint.aspx.cs" Inherits="Web.print.normal.TeamSettledPrint" MasterPageFile="~/masterpage/Print.Master" %>
    ...
    <table width="760px" align="center" class="table_normal">
        <tr>
            <td width="626" height="35" align="center" class="td_r_b_border">
                <span style="font-size: 20px; font-weight: bold;">结 算 明 细 表</span>
            </td>
