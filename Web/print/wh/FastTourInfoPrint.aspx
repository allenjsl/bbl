<%@ Page Title="行程单" Language="C#" AutoEventWireup="true" CodeBehind="FastTourInfoPrint.aspx.cs" Inherits="Web.print.wh.FastTourInfoPrint" MasterPageFile="~/masterpage/Print.Master"%>

<asp:Content ID="Content2" ContentPlaceHolderID="PrintC1" runat="server">
    <table class="table_noneborder" align="center" width="760px">
        <tbody>
            <tr>
                <td height="30">
            ...
            <tr>
                <td  style="border:1px solid #000;" height="30">
