<%@ Page Title="行程单" Language="C#" AutoEventWireup="true" CodeBehind="StandardSanFightPrint.aspx.cs" Inherits="Web.print.wh.groupend.StandardSanFightPrint" MasterPageFile="~/masterpage/Print.Master"%>
<asp:Content ID="Content2" ContentPlaceHolderID="PrintC1" runat="server">
 <table width="759" align="center" class="table_noneborder" >
                    ...
                    <asp:Repeater ID="rptTravel" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                </tr> </ItemTemplate> </asp:Repeater> </table> </td> 
        </tr>
     <tr>
     ...
     <tr>
         <td height="30">
             <table width="100%" class="table_normal">
                 <tr>
                     <td width="15%" height="25" align="center" class="normaltd">包含项目：</td>
                     <td width="85%" style="margin:0px;padding:0px;" class="normaltd">
                 ...
                 <tr>
                     <td width="15%" height="25" align="center" class="normaltd">不含项目：</td>
                     <td class="normaltd" align="left" style="margin:0px;padding:0px;">
    ...
    <tr>
        <td height="30" style="border: 1px #000 solid;" align="left">
    ...
    <tr>
        <td height="30">
            <table align="center" class="table_normal2" width="100%">
                <tbody>
                    <tr>
