<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SanFightVisitorsListPrint.aspx.cs"
    Inherits="Web.print.wh.groupend.SanFightVisitorsListPrint" MasterPageFile="~/masterpage/Print.Master"
    Title="游客名单" %>

<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="cc1" %>
<asp:Content ID="c1" ContentPlaceHolderID="PrintC1" runat="server">
    <table class="table_normal2" width="759px" align="center">
        <tr height="30">
