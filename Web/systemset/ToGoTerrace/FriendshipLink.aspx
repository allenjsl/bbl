<%@ Page Title="友情链接" Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true"
    CodeBehind="FriendshipLink.aspx.cs" Inherits="Web.systemset.ToGoTerrace.FriendshipLink" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="c1" runat="server">
                ...
                <table width="15%" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="90" align="center">
                            <a href="javascript:void(0)" class="add">新 增</a>
                        </td>
                        <%--<td width="90" align="center">
                        ...
                        <asp:Repeater ID="rptList" runat="server">
                            <ItemTemplate>
                                <tr tid="<%# Eval("Id") %>" bgcolor="<%# Container.ItemIndex%2==0?"#e3f1fc":"#BDDCF4" %>">
                                    ...
                                    <td align="center">
                                        <%# EyouSoft.Common.Utils.GetText(Eval("LinkName").ToString(),60,true)%>
                                    </td>
                                    <td align="center">
                                        <a href="<%# Eval("LinkUrl")%>" target="_blank">
                                            <%# EyouSoft.Common.Utils.GetText( Eval("LinkUrl").ToString(),50,true)%></a>
                                    </td>
                                    <td align="center">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td height="30" align="right" class="pageup" colspan="13">
                            ...
                            <asp:Label ID="lblMsg" runat="server" Text="没有相关数据"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <script type="text/javascript">
        ...
        var Others = {
            add: function() {
            var url = "/systemset/ToGoTerrace/FriendshipLinkAdd.aspx";
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "新增",
                    modal: true,
            ...
            modify: function(that) {
                var url = "/systemset/ToGoTerrace/FriendshipLinkAdd.aspx?type=modify&";
            ...
            del: function(that) {
                if (confirm("确认删除所选项?")) {
                    ...
                    $.newAjax({
                        type: "POST",
                        data: { "tid": tid },
                        url: "/systemset/ToGoTerrace/FriendshipLink.aspx?act=areadel",
                        dataType: 'json',
