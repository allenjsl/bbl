...
{  
    ...
    /// xuty 2011/1/13
    /// </summary>
    public partial class CityManage : Eyousoft.Common.Page.BackPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Utils.ResponseNoPermit(global::Common.Enum.TravelPermission.系统设置_基础设置_城市管理栏目, true);
                return;
            }
                ...
                foreach (EyouSoft.Model.CompanyStructure.Province pro in proList)
                {
                    ...
                    if (pro.CityList != null && pro.CityList.Count > 0)
                    {
                        foreach (EyouSoft.Model.CompanyStructure.City c in pro.CityList)
                        {
                            ...
                            proBuilder.AppendFormat("<td align=\"center\" ><a href=\"javascript:;\" onclick=\"return CityManage.updateCity('{0}');\">{1}</a></td>" +
                            "<td align=\"center\" ><input type=\"checkbox\" isFav='{3}'  {2} onclick=\"return CityManage.setCity('{0}',this)\" /></td>" +
                            "<td align=\"center\" ><a href=\"javascript:;\" onclick=\"return CityManage.delCity('{0}',this);\">删除</a></td></tr>", c.Id, c.CityName, c.IsFav ? "checked=\"checked\"" : "", !c.IsFav);
                            itemIndex++;
                        }
                    }
                    else
