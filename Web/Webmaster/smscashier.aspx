<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="smscashier.aspx.cs" Inherits="Web.Webmaster.smscashier" MasterPageFile="~/Webmaster/mpage.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Scripts" ID="ScriptsContent">
    <style type="text/css">
        ...
        .tblLB thead{text-align:center;background: #efefef; height:34px;}
        .tblLB tfoot{text-align: center; height: 26px; background: #fff}
        .tblLB td{border-right:1px solid #999;border-bottom:1px solid #999; line-height:32px; text-align:center;}
        .white_content td{line-height:normal;border:0px; line-height:25px;}
        .white_content{display: none;  position: absolute;  top: 10%; left: 48%; width: 300px;  height: 150px; padding: 2px; border: 4px solid orange;  background-color: white;  z-index:1002; overflow: auto;}
    </style>
...
<asp:Content runat="server" ContentPlaceHolderID="PageContent" ID="MainContent">
    <table cellpadding="2" cellspacing="1" style="font-size: 12px; width: 100%;">
        <tr>
            ...
            <option value="-1" selected="selected">所有</option>
                ...
                公司名称：<input type="text" id="txtCompanyName" name="txtCompanyName" class="input_text" maxlength="72" style="width: 150px" />
    ...
    <ItemTemplate>
        <tr onmouseover="changeTrBgColor(this,'#c8dae6')" onmouseout="changeTrBgColor(this,'#ffffff')">
            ...
            <td>
                ...
                <div style='text-align: right; z-index: 10000; display: none;' class='white_content' id='div_<%#Eval("Id") %>'>
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            <tr>
                                <td align="left">
                                    &nbsp;充值金额：<input value='<%#Eval("PayMoney") %>' type='text' id='txtPayAmount' disabled='disabled' class="input_text" style="width:180px">
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                    &nbsp;可用金额：<input type='text' value='<%#Eval("PayMoney") %>' id='txtUsableAmount_<%#Eval("Id") %>' class="input_text" style="width: 180px">
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                    &nbsp;审 核 人：<input value='<%=WebmasterRealname %>' type='text' id="txtWebmasterName_<%#Eval("Id") %>" class="input_text" style="width: 180px">
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                    &nbsp;审核时间：<input value='<%=DateTime.Now %>' type='text' disabled='disabled' class="input_text" style="width: 180px">
                                </td>
                            </tr>
                            <tr class="trspace">
                                <td></td>
                    ...
                    <iframe scrolling="no" frameborder="0" style="position: absolute; visibility: inherit; top: 0px; left: 0px; width: 100%; height: 100%; z-index: -1;" marginwidth="0" marginheight="0"></iframe>
                </div>
                </asp:PlaceHolder>
            </td>
        </tr>
    ...
    <FooterTemplate>
        <tfoot>
            <td colspan="7">
                <div id="page_change" style="width: 100%; text-align: center; margin: 0px auto 0px; margin-top:2px; margin-bottom:2px ; clear: both">
            </td>
        </tfoot>
        </table>
    </FooterTemplate>
