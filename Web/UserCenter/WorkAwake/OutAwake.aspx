<%@ Page Language="C#" MasterPageFile="~/masterpage/Back.Master" AutoEventWireup="true"
    CodeBehind="OutAwake.aspx.cs" Inherits="Web.UserCenter.WorkAwake.OutAwake" Title="出团提醒_个人中心" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="c1" runat="server">
    <% if (!string.IsNullOrEmpty(Web.Common.AwakeTab.createAwakeTab(this.SiteUserInfo, 3)))
       { %>
    <div class="mainbody">
        ...
        <div class="mainbody">
            ...
            <div class="lineCategorybox" style="height: 30px;">
                <table border="0" cellpadding="0" cellspacing="0" class="grzxnav">
                    <tr>
                        <% =Web.Common.AwakeTab.createAwakeTab(this.SiteUserInfo, 3)%>
                    </tr>
                </table>
            </div>
            <div class="btnbox">
                        ...
                        <ItemTemplate>
                            <tr bgcolor="<%# Container.ItemIndex%2==0?"#e3f1fc":"#BDDCF4" %>">
                                ...
                                <td align="center" colspan="3" style="padding: 0px; margin: 0px">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" style="border: none;
                                        border-collapse: collapse;" class="tbl" bgcolor="<%# Container.ItemIndex%2==0?"#e3f1fc":"#BDDCF4" %>">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("input.save").click(function() {
                ...
                if (r.test(duetime)) {
                    $.newAjax({
                        url: "/UserCenter/WorkAwake/OutAwake.aspx?type=duedayset",
                        type: "POST",
                        data: { "num": duetime },
                        dataType: 'json',
                        cache: false,
