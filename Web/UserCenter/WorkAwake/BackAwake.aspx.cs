...
namespace Web.UserCenter.WorkAwake
{
    ...
    /// Date:2011-01-24
    /// </summary>
    public partial class BackAwake : Eyousoft.Common.Page.BackPage
    {
        #region 变量
        ...
        /// 列表数据
        /// </summary>
        private IList<EyouSoft.Model.PersonalCenterStructure.BackTourRemind> list = new List<EyouSoft.Model.PersonalCenterStructure.BackTourRemind>();
        ...
        private void SetDay()
        {
            if (setday)
            {
                ...
                bool res = csBll.SetBackTourReminderDays(CurrentUserCompanyID, day);
        ...
        private void DataInit()
        {
            ...
            day = csBll.GetBackTourReminderDays(CurrentUserCompanyID);
            list = trBll.GetBackTourRemind(pageSize, pageIndex, ref recordCount, CurrentUserCompanyID, day);
