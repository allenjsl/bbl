<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xianluList.aspx.cs" Inherits="Web.Common.xianluList" %>
  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td><div class="searchbox">
          ...
          <label>发布起始时间：</label>
          <input name="txt_date" type="text" runat="server" class="searchinput" id="txt_date" onfocus="WdatePicker()"/>
<label>发布结束时间：</label>
          <input name="txt_endDate" type="text" runat="server" class="searchinput" id="txt_endDate" onfocus="WdatePicker()"/>
  ...
  <table width="900" border="0" align="center" cellpadding="0" cellspacing="1">
   ...
   <%if (i % 4 == 0)
    ...
    <%}
      ...
      %>     <td width="250"><input type="radio" name="radio" id="radio2" area="<%#Eval("AreaId") %>" value="<%#Eval("RouteId")%>" /><%#Eval("RouteName")%></td>
      <%i++; %>
    </ItemTemplate>
   </asp:Repeater>
...
<script type="text/javascript">
    ...
    $(function() {
        $("#selectxl").click(function() {
            ...
            {
                window.parent.$("#" + queryString("txtname")).val($("[type=radio]:checked").parent().text());
