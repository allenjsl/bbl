...
//    document.getElementById("timeDiv").innerHTML=nowDate.toLocaleDateString()+//   ' 星期'+'日一二三四五六'.charAt(nowDate.getDay())+' '+nowDate.toLocaleTimeString();
   
   serverDate.setSeconds(serverDate.getSeconds()+1);
   document.getElementById("timeDiv").innerHTML=serverDate.toLocaleDateString()+   ' 星期'+'日一二三四五六'.charAt(serverDate.getDay())+' '+serverDate.toLocaleTimeString();
 }
