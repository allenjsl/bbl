...
namespace EyouSoft.Toolkit.DAL
{
    ...
    public static class DbHelper
    {
        ...
        /// <returns></returns>
        public static IDataReader ExecuteReaderIsGroupBy(Database db, int pageSize, int pageIndex, ref int recordCount, string tableName, string identityColumnName, string fields, string query, string orderByString, bool IsGroupBy)
        {
            DbCommand cmd = db.GetStoredProcCommand("T_StocPage");
            db.AddInParameter(cmd, "PageSize", DbType.Int32, pageSize);
            db.AddInParameter(cmd, "PageIndex", DbType.Int32, pageIndex);
        ...
        /// <param name="IsGroupBy">条件是否分组</param>
        /// <returns></returns>
        public static IDataReader ExecuteReaderBySqlTbl(Database db, int pageSize, int pageIndex, ref int recordCount, string sqlTbl, string fields, string query, string orderByString, bool IsGroupBy)
        {
            DbCommand cmd = db.GetStoredProcCommand("proc_Pading_BySqlTable");
            db.AddInParameter(cmd, "PageSize", DbType.Int32, pageSize);
            db.AddInParameter(cmd, "PageIndex", DbType.Int32, pageIndex);
            db.AddInParameter(cmd, "TableName", DbType.String, sqlTbl);
            db.AddInParameter(cmd, "FieldsList", DbType.String, fields);
            db.AddInParameter(cmd, "FieldSearchKey", DbType.String, query);
            db.AddInParameter(cmd, "OrderString", DbType.String, orderByString);
            db.AddInParameter(cmd, "IsGroupBy", DbType.String, IsGroupBy ? "1" : "0");
