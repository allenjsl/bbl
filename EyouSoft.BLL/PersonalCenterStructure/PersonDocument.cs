            ...
            if (Result)
            {
                HandleLogsBll.Add(
                       new EyouSoft.Model.CompanyStructure.SysHandleLogs()
                       {
                           ...
                           EventMessage = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "{0}在" + Model.EnumType.CompanyStructure.SysPermissionClass.个人中心_文档管理.ToString() + "新增了个人文档！编号为：" + model.DocumentId,
                           EventTitle = "新增" + Model.EnumType.CompanyStructure.SysPermissionClass.个人中心_文档管理.ToString() + "数据"
                       });
            }
            return Result;
        }
            ...
            if (Result)
            {
                ...
                HandleLogsBll.Add(
                       new EyouSoft.Model.CompanyStructure.SysHandleLogs()
                       {
                           ModuleId = EyouSoft.Model.EnumType.CompanyStructure.SysPermissionClass.个人中心_文档管理,
                           EventCode = Model.CompanyStructure.SysHandleLogsNO.EventCode,
                           EventMessage = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "{0}在" + Model.EnumType.CompanyStructure.SysPermissionClass.个人中心_文档管理.ToString() + "删除了个人文档！编号为：" + strIDs.TrimEnd(','),
                           EventTitle = "删除" + Model.EnumType.CompanyStructure.SysPermissionClass.个人中心_文档管理.ToString() + "数据"
                       });
            }
            return Result;
        }
