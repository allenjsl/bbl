...
namespace EyouSoft.BLL.SMSStructure
{
    ...
    public class CustomerList
    {
        ...
        private EyouSoft.Model.CompanyStructure.SysHandleLogs AddLogs(string actionName, bool flag)
        {
            ...
            model.ModuleId = EyouSoft.Model.EnumType.CompanyStructure.SysPermissionClass.短信中心_短信中心;
            model.EventCode = Model.CompanyStructure.SysHandleLogsNO.EventCode;
            model.EventMessage = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "{0}在" + Model.EnumType.CompanyStructure.SysPermissionClass.短信中心_短信中心.ToString() + (flag ? actionName : actionName + "失败") + "!";
            model.EventTitle = (flag ? actionName+"在" : actionName + "失败在") + Model.EnumType.CompanyStructure.SysPermissionClass.短信中心_短信中心.ToString();
